    ...
    def port_forwarding_window(self, ns_view):
        ...
        if(utils.checkuid[0] == "0"):
            ...
            if len(namespaces_list) < 1:
                ...
                add_ns_btn = Button(port_forward_window, text='Submit', command = lambda: utils.enable_ns_to_ns_ip_forwarding(self.subnet, device1, device2, forward_from, forward_to))
